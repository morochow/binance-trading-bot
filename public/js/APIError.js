        ...
        <div className='lock-screen-wrapper d-flex flex-column justify-content-center'>
          ...
          <div className='text-left'>
            ...
            <p>
              ...
              <br />
              <a
                href='https://github.com/morochow/binance-trading-bot/wiki/Install#how-to-install'
                target='_blank'
                rel='noreferrer'>
                https://github.com/morochow/binance-trading-bot/wiki/Install#how-to-install
              </a>
              <br />
              <br />
